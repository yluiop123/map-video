...
export default {
  ...
  camera_keyframe: {
    ...
    follow_start_sec: '跟随动画开始时间（秒，默认取路线显示起点）',
    follow_end_sec: '跟随动画结束时间（秒，默认取路线显示终点）',
  ...
  narration_entry: {
    ...
    duration_sec: '字幕显示时长（秒）；有配音时长随音频，无配音按字数估算，均可手动覆盖',
  ...
  music_track: {
    ...
    name: '曲目名',
    audio_asset_id: '音频素材',
    start_sec: '起效起始时间（秒，章内绝对时间轴）',
    end_sec: '起效结束时间（秒，章内绝对时间轴）',
    volume: '音量（0–1）',
    loop: '是否循环播放',
    fade_in: '淡入时长（秒）',
    fade_out: '淡出时长（秒）',
